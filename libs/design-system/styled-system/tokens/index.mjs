const tokens = {
  ...
  "gradients.vertical": {
    "value": "linear-gradient(0deg, var(--nv-colors-legacy-gradient-start) 0%, var(--nv-colors-legacy-gradient-end) 100%)",
    "variable": "var(--nv-gradients-vertical)"
  },
  "gradients.horizontal": {
    "value": "linear-gradient(99deg, var(--nv-colors-legacy-gradient-end) 0%, var(--nv-colors-legacy-gradient-start) 100%)",
